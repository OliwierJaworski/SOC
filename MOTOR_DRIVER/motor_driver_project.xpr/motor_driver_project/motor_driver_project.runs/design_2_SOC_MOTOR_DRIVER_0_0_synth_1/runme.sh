...
HD_PWD='C:/Users/oliwi/Documents/SOC/motor_driver_project/motor_driver_project.runs/design_2_SOC_MOTOR_DRIVER_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_SOC_MOTOR_DRIVER_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_SOC_MOTOR_DRIVER_0_0.tcl
