...
HD_PWD='C:/Users/oliwi/Documents/SOC/motor_driver_project/motor_driver_project.runs/design_1_SOC_MOTOR_DRIVER_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_SOC_MOTOR_DRIVER_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_SOC_MOTOR_DRIVER_0_1.tcl
