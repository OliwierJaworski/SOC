...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = Motor_DriverIP
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Motor_DriverIP_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = SpeedSensor_Driver_IP
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = SpeedSensor_Driver_IP_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = SpeedSensor_Driver_IP
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = SpeedSensor_Driver_IP_1
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = ultrasoneIP
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ultrasoneIP_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = ultrasoneIP
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ultrasoneIP_1
END
