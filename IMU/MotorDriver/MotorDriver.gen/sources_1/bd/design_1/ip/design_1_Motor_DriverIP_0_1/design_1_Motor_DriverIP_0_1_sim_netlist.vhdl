...
-- Date        : Sun May  4 12:44:59 2025
-- Host        : pcoli-System-Product-Name running 64-bit Ubuntu 24.10
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_Motor_DriverIP_0_1 -prefix
--               design_1_Motor_DriverIP_0_1_ design_1_Motor_DriverIP_0_0_sim_netlist.vhdl
-- Design      : design_1_Motor_DriverIP_0_0
...
entity design_1_Motor_DriverIP_0_1_motor_driver is
  port (
    Mout : out STD_LOGIC_VECTOR ( 3 downto 0 );
    p_1_in_1 : in STD_LOGIC_VECTOR ( 2 downto 0 );
    Reset : in STD_LOGIC;
    Clk : in STD_LOGIC;
    PwmI : in STD_LOGIC
  );
end design_1_Motor_DriverIP_0_1_motor_driver;

architecture STRUCTURE of design_1_Motor_DriverIP_0_1_motor_driver is
  signal \FSM_onehot_Mfsm[0]_i_1_n_0\ : STD_LOGIC;
  signal \FSM_onehot_Mfsm[1]_i_1_n_0\ : STD_LOGIC;
  signal \FSM_onehot_Mfsm[2]_i_1_n_0\ : STD_LOGIC;
  signal \FSM_onehot_Mfsm[2]_i_2_n_0\ : STD_LOGIC;
  signal \FSM_onehot_Mfsm_reg_n_0_[1]\ : STD_LOGIC;
  signal MotorP : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \Motor_driver.MotorP[0]_i_1_n_0\ : STD_LOGIC;
  signal \Motor_driver.MotorP[1]_i_1_n_0\ : STD_LOGIC;
  signal \Motor_driver.MotorP[2]_i_1_n_0\ : STD_LOGIC;
  signal \Mout[0]_i_1_n_0\ : STD_LOGIC;
  signal \Mout[1]_i_1_n_0\ : STD_LOGIC;
  signal \Mout[2]_i_1_n_0\ : STD_LOGIC;
  signal \Mout[3]_i_1_n_0\ : STD_LOGIC;
  signal motor_out : STD_LOGIC;
  signal motor_out0 : STD_LOGIC;
  signal \motor_out[0]_i_1_n_0\ : STD_LOGIC;
  signal \motor_out[1]_i_1_n_0\ : STD_LOGIC;
  signal \motor_out[2]_i_1_n_0\ : STD_LOGIC;
  signal \motor_out[3]_i_1_n_0\ : STD_LOGIC;
  signal \motor_out_reg_n_0_[0]\ : STD_LOGIC;
  signal \motor_out_reg_n_0_[1]\ : STD_LOGIC;
  signal \motor_out_reg_n_0_[2]\ : STD_LOGIC;
  signal \motor_out_reg_n_0_[3]\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_onehot_Mfsm[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \FSM_onehot_Mfsm[2]_i_1\ : label is "soft_lutpair0";
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \FSM_onehot_Mfsm_reg[0]\ : label is "idle:010,demux:100,setup:001";
  attribute FSM_ENCODED_STATES of \FSM_onehot_Mfsm_reg[1]\ : label is "idle:010,demux:100,setup:001";
  attribute FSM_ENCODED_STATES of \FSM_onehot_Mfsm_reg[2]\ : label is "idle:010,demux:100,setup:001";
  attribute SOFT_HLUTNM of \Mout[0]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \Mout[1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \Mout[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \Mout[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \motor_out[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \motor_out[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \motor_out[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \motor_out[3]_i_1\ : label is "soft_lutpair1";
begin
\FSM_onehot_Mfsm[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => \FSM_onehot_Mfsm_reg_n_0_[1]\,
      I1 => Reset,
      O => \FSM_onehot_Mfsm[0]_i_1_n_0\
    );
\FSM_onehot_Mfsm[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFAAAE"
    )
        port map (
      I0 => motor_out0,
      I1 => \FSM_onehot_Mfsm_reg_n_0_[1]\,
      I2 => \FSM_onehot_Mfsm[2]_i_2_n_0\,
      I3 => Reset,
      I4 => motor_out,
      O => \FSM_onehot_Mfsm[1]_i_1_n_0\
    );
\FSM_onehot_Mfsm[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00CC00C8"
    )
        port map (
      ...
      I3 => Reset,
      I4 => motor_out,
      O => \FSM_onehot_Mfsm[2]_i_1_n_0\
    );
\FSM_onehot_Mfsm[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => p_1_in_1(1),
      I5 => MotorP(1),
      O => \FSM_onehot_Mfsm[2]_i_2_n_0\
    );
\FSM_onehot_Mfsm_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
      C => Clk,
      CE => '1',
      D => \FSM_onehot_Mfsm[0]_i_1_n_0\,
      Q => motor_out0,
      R => '0'
    );
\FSM_onehot_Mfsm_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => Clk,
      CE => '1',
      D => \FSM_onehot_Mfsm[1]_i_1_n_0\,
      Q => \FSM_onehot_Mfsm_reg_n_0_[1]\,
      R => '0'
    );
\FSM_onehot_Mfsm_reg[2]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => Clk,
      CE => '1',
      D => \FSM_onehot_Mfsm[2]_i_1_n_0\,
      Q => motor_out,
      R => '0'
    );
\Motor_driver.MotorP[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000EA2A"
    )
        port map (
      I0 => MotorP(0),
      I1 => \FSM_onehot_Mfsm[2]_i_2_n_0\,
      I2 => \FSM_onehot_Mfsm_reg_n_0_[1]\,
      I3 => p_1_in_1(0),
      I4 => motor_out0,
      O => \Motor_driver.MotorP[0]_i_1_n_0\
    );
\Motor_driver.MotorP[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000EA2A"
    )
        port map (
      ...
      I3 => p_1_in_1(1),
      I4 => motor_out0,
      O => \Motor_driver.MotorP[1]_i_1_n_0\
    );
\Motor_driver.MotorP[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000EA2A"
    )
        port map (
      ...
      I3 => p_1_in_1(2),
      I4 => motor_out0,
      O => \Motor_driver.MotorP[2]_i_1_n_0\
    );
\Motor_driver.MotorP_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => Clk,
      CE => '1',
      D => \Motor_driver.MotorP[0]_i_1_n_0\,
      Q => MotorP(0),
      R => '0'
    );
\Motor_driver.MotorP_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => Clk,
      CE => '1',
      D => \Motor_driver.MotorP[1]_i_1_n_0\,
      Q => MotorP(1),
      R => '0'
    );
\Motor_driver.MotorP_reg[2]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => Clk,
      CE => '1',
      D => \Motor_driver.MotorP[2]_i_1_n_0\,
      Q => MotorP(2),
      R => '0'
    );
\Mout[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => \motor_out_reg_n_0_[0]\,
      I1 => PwmI,
      O => \Mout[0]_i_1_n_0\
    );
\Mout[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => \motor_out_reg_n_0_[1]\,
      I1 => PwmI,
      O => \Mout[1]_i_1_n_0\
    );
\Mout[2]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => \motor_out_reg_n_0_[2]\,
      I1 => PwmI,
      O => \Mout[2]_i_1_n_0\
    );
\Mout[3]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => \motor_out_reg_n_0_[3]\,
      I1 => PwmI,
      O => \Mout[3]_i_1_n_0\
    );
\Mout_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => Clk,
      CE => \FSM_onehot_Mfsm_reg_n_0_[1]\,
      D => \Mout[0]_i_1_n_0\,
      Q => Mout(0),
      R => motor_out0
    );
\Mout_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\Mout_reg[2]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\Mout_reg[3]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\motor_out[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => p_1_in_1(0),
      I1 => p_1_in_1(1),
      O => \motor_out[0]_i_1_n_0\
    );
\motor_out[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => p_1_in_1(0),
      I1 => p_1_in_1(1),
      O => \motor_out[1]_i_1_n_0\
    );
\motor_out[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"24"
    )
        port map (
      ...
      I1 => p_1_in_1(1),
      I2 => p_1_in_1(2),
      O => \motor_out[2]_i_1_n_0\
    );
\motor_out[3]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"82"
    )
        port map (
      ...
      I1 => p_1_in_1(1),
      I2 => p_1_in_1(0),
      O => \motor_out[3]_i_1_n_0\
    );
\motor_out_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => Clk,
      CE => motor_out,
      D => \motor_out[0]_i_1_n_0\,
      Q => \motor_out_reg_n_0_[0]\,
      R => motor_out0
    );
\motor_out_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => Clk,
      CE => motor_out,
      D => \motor_out[1]_i_1_n_0\,
      Q => \motor_out_reg_n_0_[1]\,
      R => motor_out0
    );
\motor_out_reg[2]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => Clk,
      CE => motor_out,
      D => \motor_out[2]_i_1_n_0\,
      Q => \motor_out_reg_n_0_[2]\,
      R => motor_out0
    );
\motor_out_reg[3]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => Clk,
      CE => motor_out,
      D => \motor_out[3]_i_1_n_0\,
      Q => \motor_out_reg_n_0_[3]\,
      R => motor_out0
    );
end STRUCTURE;
library IEEE;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_Motor_DriverIP_0_1_Motor_DriverIP_slave_lite_v1_0_S00_AXI is
  port (
    Mout : out STD_LOGIC_VECTOR ( 3 downto 0 );
...
end design_1_Motor_DriverIP_0_1_Motor_DriverIP_slave_lite_v1_0_S00_AXI;

architecture STRUCTURE of design_1_Motor_DriverIP_0_1_Motor_DriverIP_slave_lite_v1_0_S00_AXI is
  signal \IP_MSelect[0]_i_1_n_0\ : STD_LOGIC;
  signal \IP_MSelect[1]_i_1_n_0\ : STD_LOGIC;
  signal \IP_MSelect[2]_i_1_n_0\ : STD_LOGIC;
  signal \IP_MSelect[2]_i_2_n_0\ : STD_LOGIC;
  ...
  signal reg_data_out_0 : STD_LOGIC_VECTOR ( 31 downto 3 );
  ...
  attribute SOFT_HLUTNM of \reg_data_out_reg[31]_i_2\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \reg_data_out_reg[3]_i_1\ : label is "soft_lutpair5";
...
AXI_Motor_Driver: entity work.design_1_Motor_DriverIP_0_1_motor_driver
     port map (
      Clk => Clk,
      Mout(3 downto 0) => Mout(3 downto 0),
      PwmI => PwmI,
      Reset => Reset,
      p_1_in_1(2 downto 0) => p_1_in_1(2 downto 0)
    );
\IP_MSelect[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BFFF8000"
    )
        port map (
      I0 => s00_axi_wdata(0),
      I1 => s00_axi_aresetn,
      I2 => \IP_MSelect[2]_i_2_n_0\,
      I3 => \slv_reg_wren__2\,
      I4 => p_1_in_1(0),
      O => \IP_MSelect[0]_i_1_n_0\
    );
\IP_MSelect[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BFFF8000"
    )
        port map (
      ...
      I3 => \slv_reg_wren__2\,
      I4 => p_1_in_1(1),
      O => \IP_MSelect[1]_i_1_n_0\
    );
\IP_MSelect[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BFFF8000"
    )
        port map (
      ...
      I3 => \slv_reg_wren__2\,
      I4 => p_1_in_1(2),
      O => \IP_MSelect[2]_i_1_n_0\
    );
\IP_MSelect[2]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"02"
    )
        port map (
      ...
      I1 => p_0_in_2(0),
      I2 => p_0_in_2(1),
      O => \IP_MSelect[2]_i_2_n_0\
    );
\IP_MSelect[2]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\IP_MSelect_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \IP_MSelect[0]_i_1_n_0\,
      Q => p_1_in_1(0),
      R => '0'
    );
\IP_MSelect_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \IP_MSelect[1]_i_1_n_0\,
      Q => p_1_in_1(1),
      R => '0'
    );
\IP_MSelect_reg[2]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_Motor_DriverIP_0_1_Motor_DriverIP is
  port (
    Mout : out STD_LOGIC_VECTOR ( 3 downto 0 );
    S_AXI_WREADY : out STD_LOGIC;
    S_AXI_AWREADY : out STD_LOGIC;
...
end design_1_Motor_DriverIP_0_1_Motor_DriverIP;

architecture STRUCTURE of design_1_Motor_DriverIP_0_1_Motor_DriverIP is
begin
Motor_DriverIP_slave_lite_v1_0_S00_AXI_inst: entity work.design_1_Motor_DriverIP_0_1_Motor_DriverIP_slave_lite_v1_0_S00_AXI
     port map (
      Clk => Clk,
      Mout(3 downto 0) => Mout(3 downto 0),
      PwmI => PwmI,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_Motor_DriverIP_0_1 is
  port (
    Clk : in STD_LOGIC;
    PwmI : in STD_LOGIC;
    Mout : out STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute NotValidForBitStream of design_1_Motor_DriverIP_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_Motor_DriverIP_0_1 : entity is "design_1_Motor_DriverIP_0_0,Motor_DriverIP,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_Motor_DriverIP_0_1 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_Motor_DriverIP_0_1 : entity is "Motor_DriverIP,Vivado 2024.1";
end design_1_Motor_DriverIP_0_1;

architecture STRUCTURE of design_1_Motor_DriverIP_0_1 is
...
U0: entity work.design_1_Motor_DriverIP_0_1_Motor_DriverIP
     port map (
      Clk => Clk,
      Mout(3 downto 0) => Mout(3 downto 0),
      PwmI => PwmI,
