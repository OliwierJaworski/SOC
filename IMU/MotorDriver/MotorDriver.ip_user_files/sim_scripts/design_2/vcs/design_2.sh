...
design_libs=(xilinx_vip xpm xil_defaultlib xbip_utils_v3_0_13 c_reg_fd_v12_0_9 xbip_dsp48_wrapper_v3_0_6 xbip_pipe_v3_0_9 xbip_dsp48_addsub_v3_0_9 xbip_addsub_v3_0_9 c_addsub_v12_0_18 c_gate_bit_v12_0_9 xbip_counter_v3_0_9 c_counter_binary_v12_0_19)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../MotorDriver.gen/sources_1/bd/design_2/ipshared/3242" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../MotorDriver.gen/sources_1/bd/design_2/ipshared/3242" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../MotorDriver.gen/sources_1/bd/design_2/ipshared/3242" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/pcoli/Project_Folder/Xilinx_Vivado/MotorDriver/MotorDriver.cache/compile_simlib/vcs"
  fi
